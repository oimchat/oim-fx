...
public class GroupCategoryMenuViewImpl extends AbstractView implements GroupCategoryMenuView {
	...
	private MenuItem addCategoryMenuItem = new MenuItem();
	private MenuItem findGroupMenuItem = new MenuItem();
	private MenuItem updateCategoryNameMenuItem = new MenuItem();
