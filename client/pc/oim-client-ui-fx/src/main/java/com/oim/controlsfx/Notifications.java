package com.oim.controlsfx;
/**
 * @author: XiaHui
 * @date: 2017年10月13日 下午12:03:59
 */
...
import com.oim.controlsfx.skin.NotificationBar;
...
public class Notifications {
    ...
    public Notifications textColor(String textColor) {
    ...
    private static final class NotificationPopupHandler {
        ...
        private void show(Window owner, final Notifications notification) {
            ...
            if (ownerScene != null) {
                String stylesheetUrl = Notifications.class.getResource("/org/controlsfx/control/notificationpopup.css").toExternalForm(); //$NON-NLS-1$
